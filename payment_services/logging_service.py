...
from decorator_protocol import PaymentServiceDecoratorPotocol
from services_protocol import PaymentServiceProtocol
from commons import CustomerData, PaymentData, PaymentResponse


@dataclass
class PaymentServiceLogging(PaymentServiceDecoratorPotocol):
    ...
    def setup_recurring(
        ...
        response = self.setup_recurring(customer_data, payment_data)
        print('Finish process refund')
        return response